...
const resources = {
    ...
    de: {
        translation: {
            ...
            "Introduction p": "Willkommen bei Give and Take Hub, einer mobilen Anwendung, die Nutzern eine Online-Plattform bietet, auf der sie anonym Gegenstände oder Dienstleistungen kostenlos anbieten oder anfordern können. Diese Nutzungsbedingungen ('Bedingungen') regeln Ihre Nutzung der App und der über sie bereitgestellten Dienste. Mit der Nutzung der App erklären Sie sich mit diesen Bedingungen einverstanden.",
